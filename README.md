...
We used the rolling window cross-validation method to validate our model. Two bar charts below show the percentage error of the forecast data for one month, three months, six months and twelve months. 
![Error_1.png](images/Error_1.png) ![Error_2.png](images/Error_2.png)
